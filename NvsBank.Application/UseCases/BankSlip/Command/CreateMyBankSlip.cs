...
public abstract class CreateMyBankSlip
{
    public sealed record CreateMyBankSlipCommand : IRequest<BankSlipResponse>
    {
        public decimal Amount { get; set; }
        public Guid AccountPayeeId { get; private set; }
        public Guid CustomerPayerId { get; set; }
        
        public void SetPayeeAccount(Guid accountPayeeId) => AccountPayeeId = accountPayeeId;
    }
    
    public class CreateBankSlipHandler : IRequestHandler<CreateMyBankSlipCommand, BankSlipResponse>
    {
        ...
        public async Task<BankSlipResponse> Handle(CreateMyBankSlipCommand request, CancellationToken cancellationToken)
        {
